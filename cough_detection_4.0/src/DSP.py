...
def classify_cough(x, fs, model, scaler):
    ...
    try:
        ...
        FREQ_CUTS = [(0, 200), (300, 500), (600, 800), (900, 1100), (1200, 1600), (1800, 2200), (2400, 2800),
                     (3000, 4000)]
        #
        # FREQ_CUTS = [(0, 200), (250, 350), (400, 600), (750, 1250), (1350, 1750), (2000, 2500), (2600, 3000),
        #              (3500, 4000)]

        # FREQ_CUTS = [(0, 200), (300, 1000), (1200, 4000)]
